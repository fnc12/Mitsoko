...
auto UI::BarButtonItem::initWithImage(const UI::Image &image,Style style,const NS::Object &target,SEL action)->Handle{
...
auto UI::BarButtonItem::initWithTitle(const CF::String &title,Style style,const NS::Object &target,SEL action)->Handle{
